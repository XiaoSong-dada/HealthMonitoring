...
if __name__ == '__main__':
    ...
    json_path_train = r'./coco2017/annotations/person_keypoints_train2017.json'
    image_info_all_train = coco2yolo_pose_get_dict(json_path_train)
 
    save_path_train = r'./coco2017/pose_ren/labels/train2017'
    txt_path_train = r'./coco2017/train2017_pose.txt'
    save_yolo_labels(image_info_all_train, save_path_train, './images/train2017', txt_path_train)

    json_path_val = r'./coco2017/annotations/person_keypoints_val2017.json'
    image_info_all_val = coco2yolo_pose_get_dict(json_path_val)
 
    save_path_val = r'./coco2017/pose_ren/labels/val2017'
    txt_path_val = r'./coco2017/val2017_pose.txt'
    save_yolo_labels(image_info_all_val, save_path_val, './images/val2017', txt_path_val)